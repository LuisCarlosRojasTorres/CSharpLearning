...
namespace Dummy_DBVariable
{
    public class DBVariable2
    {
        ...
        public DBVariable2(string key, string[] dates, string[] values, bool[] hidden)
        {
            this.Key = key;
        ...
        public DBVariable2(string key, string value, bool hidden = false)
        {
            this.Key = key;
